...
@Named
@ViewScoped
public class horaLiteController extends Auxiliar implements Serializable {
        ...
        try {
            if (selected != null) {
                ...
                persistirNotificación(
                        new mensaje(0, us.getIdpersona(), "horarioLite<form",
                        ...
                        new Persona(selected.getMaestro().getIdmaestro()),
                        notiFL, notificacion);
            } else {
        ...
        if (selected != null) {
            ...
            if (!e.isEmpty() && !e.get(0).getMestroHorarioMateriasPK().equals(pk)) {
                ...
                persistirNotificación(
                        ...
                        new Persona(m.getMaestro().getIdmaestro()),
                        notiFL, notificacion);
            }
            init2();
            PrimeFaces.current().ajax().update(":form:horario", "f1");
