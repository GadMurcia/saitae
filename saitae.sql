...
CREATE TABLE `contribuciones` (
  ...
  KEY `fk_contribuciones_1_idx` (`idPersona`),
  CONSTRAINT `fk_contribuciones_1` FOREIGN KEY (`idPersona`) REFERENCES `estudiante` (`idestudiante`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_contribuciones_2` FOREIGN KEY (`idPersona`) REFERENCES `persona` (`idpersona`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `evaluacionMaestro` (
  ...
  `faceIniciacion` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`faceIniciacion`)),
  `faceDesarrollo` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`faceDesarrollo`)),
  `FaceCulminación` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`FaceCulminación`)),
  ...
  CONSTRAINT `fk_evaluacionMaestro_2` FOREIGN KEY (`grado`, `seccion`, `año`) REFERENCES `grado` (`idgrado`, `gradoSeccion`, `gradoAño`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `grado` (
  ...
  PRIMARY KEY (`idgrado`,`gradoSeccion`,`gradoAño`),
  KEY `fk_grado_1_idx` (`aulaGrado`),
  KEY `fk_grado_2_idx` (`gradoMaestroGuia`),
  CONSTRAINT `fk_grado_1` FOREIGN KEY (`aulaGrado`) REFERENCES `aula` (`idaula`) ON UPDATE CASCADE,
  CONSTRAINT `fk_grado_2` FOREIGN KEY (`gradoMaestroGuia`) REFERENCES `maestro` (`idmaestro`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gradoEvaluacion` (
  ...
  CONSTRAINT `fk_gradoEvaluacion_1` FOREIGN KEY (`idGrado`, `gradoSeccion`, `gradoAño`) REFERENCES `grado` (`idgrado`, `gradoSeccion`, `gradoAño`) ON UPDATE CASCADE,
...
CREATE TABLE `matricula` (
  ...
  `matriculaModalidad` varchar(45) NOT NULL,
  `matriculaRepite` bit(1) NOT NULL,
  `matriculaComentario` varchar(140) DEFAULT NULL,
  PRIMARY KEY (`idmatricula`,`matriculaNivel`,`matriculaSeccion`,`matriculaAnyo`),
  KEY `fk_matricula_1_idx` (`matriculaNivel`,`matriculaSeccion`,`matriculaAnyo`),
  CONSTRAINT `fk_matricula1_1` FOREIGN KEY (`idmatricula`) REFERENCES `estudiante` (`idestudiante`) ON UPDATE CASCADE,
  CONSTRAINT `fk_matricula_1` FOREIGN KEY (`matriculaNivel`, `matriculaSeccion`, `matriculaAnyo`) REFERENCES `grado` (`idgrado`, `gradoSeccion`, `gradoAño`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mestroHorarioMaterias` (
  ...
  KEY `fk_mestroHorarioMaterias_4_idx` (`idGrado`,`seccionGrado`,`añoGrado`),
  ...
  CONSTRAINT `fk_mestroHorarioMaterias_4` FOREIGN KEY (`idGrado`, `seccionGrado`, `añoGrado`) REFERENCES `grado` (`idgrado`, `gradoSeccion`, `gradoAño`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tipoNombramiento` (
  `idtipoNombramiento` int(11) NOT NULL,
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zona` (
  `idzona` int(11) NOT NULL COMMENT 'La Identificación de la zona geográfica (1°, 2° y 3°) en la que está dividido el instituto.',
...
-- Dump completed on 2019-07-14 11:26:50