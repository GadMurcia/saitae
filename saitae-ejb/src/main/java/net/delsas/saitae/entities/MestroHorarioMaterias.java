...
@NamedQueries({
    ...
    @NamedQuery(name = "MestroHorarioMaterias.findAllOrdered", query = "SELECT m FROM MestroHorarioMaterias m WHERE m.grado.gradoPK.gradoAño = :año ORDER BY m.diasEstudio, m.horario, m.grado"),
